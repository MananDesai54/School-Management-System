...
<body>
    ...
    <form class="signup" action="TeacherSignUp" method="post">
    	<%
        ...
        <div class="input">
			...
			<input type="text" name="subject" class="field standard" id="standard" placeholder="subject" required>
        ...
        <div class="link">
        	<a href="signup.jsp">Create Student Account</a>
        </div>
    </form><%}%>
    <script>
